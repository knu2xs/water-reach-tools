...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=water-reach-tools
SET SUPPORT_LIBRARY = water_reach_tools
SET ENV_NAME=water-reach-tools
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/water-reach-tools*.tar.bz2
